...
public class AtaqueMejora extends AtaqueOfensivos {
	...
	public AtaqueMejora(String nombre, String tipo,int potencia, int precision, int pp, boolean prioridad, String caracteristica, int cantidad) {
	...
	public void mejorarCaracteristica(Pokemon pAtacante ) {
		...
		if(this.caracteristica.equalsIgnoreCase("AtF")) {
			...
			if(pAtacante.getNivAtE() <=6) {			
				...
				else if(pAtacante.getNivAtF()>0 && pAtacante.getNivAtE()<=6) {
					suma = 1;
